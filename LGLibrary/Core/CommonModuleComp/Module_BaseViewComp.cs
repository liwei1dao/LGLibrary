...
namespace LG
{
    ...
    public abstract class Module_BaseViewComp : ModelCompBase, ViewComp
    {
        ...
        public override void LGLoad(ModuleBase module, params object[] agrs)
        {
            ...
            UIGameobject = GUIManagerModule.Instance.CreateView(this, Module.LoadAsset<GameObject>("Prefab", PrefabName));
            GUIManagerModule.Instance.SetViewToTop(this);
        }

        public override void Close()
        {
            GUIManagerModule.Instance.DeletView(this);
    ...
    public class Model_BaseViewComp<C> : ModelCompBase<C>, ViewComp where C : ModuleBase, new()
    {
        ...
        public override void LGLoad(ModuleBase module, params object[] agr)
        {
            ...
            if (option == UIOption.Create)
            {
                ...
                UIGameobject = GUIManagerModule.Instance.CreateView(this, uiasset);
            }
            else if (option == UIOption.Find)
            {
                UIGameobject = GUIManagerModule.Instance.FindView(this, PrefabName);
            }
            else if (option == UIOption.Empty)
            {
                UIGameobject = GUIManagerModule.Instance.CreateEmptyView(this, PrefabName);
            }
            else
            {
                UIGameobject = GUIManagerModule.Instance.FindView(this, PrefabName);
