    ...
    public class ExpressInterstitialAdComp : ModelCompBase<PangolinAdvModule>, IExpressAdListener, IExpressAdInteractionListener
    {
        ...
        private void ShowAdv_IOS(string advId)
        {
            ...
            var adSlot = new AdSlot.Builder()
                        ...
                        .Build();
            this.Module.AdNative.LoadExpressInterstitialAd(adSlot, this);
        }
        ...
        public void OnExpressAdLoad(List<ExpressAd> ads)
        {
            ...
            this.mExpressInterstitialAd.SetDownloadListener(Module);
            NativeAdManager.Instance().ShowExpressInterstitialAd(Module.GetActivity(), mExpressInterstitialAd.handle, this);
        }
#if UNITY_IOS
